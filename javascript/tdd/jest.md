...
Copied from [this cheatsheet](https://github.com/sapegin/jest-cheat-sheet/blob/master/Readme.md)
...
CC0 1.0 Universal license, see the included [License.md](https://github.com/sapegin/jest-cheat-sheet/blob/master/License.md) file.
